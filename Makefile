...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Sep 27 19:53:03 2018
# Project:  SSD1603_Emulator.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++-64 CONFIG+=debug -o Makefile SSD1603_Emulator.pro
#############################################################################
...
SOURCES       = main.cpp \
		emulator.cpp \
		aboutdialog.cpp \
		mainwindow.cpp moc_emulator.cpp \
		moc_aboutdialog.cpp \
		moc_mainwindow.cpp \
		qrc_emulator.cpp \
		qrc_about.cpp
...
$(TARGET): ui_emulator.h ui_aboutdialog.h ui_mainwindow.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/SSD1603_Emulator1.0.0/ && $(COPY_FILE) --parents emulator.h gfxfont.h aboutdialog.h app_types.h mainwindow.h .tmp/SSD1603_Emulator1.0.0/ && $(COPY_FILE) --parents emulator.qrc about.qrc .tmp/SSD1603_Emulator1.0.0/ && $(COPY_FILE) --parents main.cpp emulator.cpp aboutdialog.cpp mainwindow.cpp .tmp/SSD1603_Emulator1.0.0/ && $(COPY_FILE) --parents emulator.ui aboutdialog.ui mainwindow.ui .tmp/SSD1603_Emulator1.0.0/ && (cd `dirname .tmp/SSD1603_Emulator1.0.0` && $(TAR) SSD1603_Emulator1.0.0.tar SSD1603_Emulator1.0.0 && $(COMPRESS) SSD1603_Emulator1.0.0.tar) && $(MOVE) `dirname .tmp/SSD1603_Emulator1.0.0`/SSD1603_Emulator1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/SSD1603_Emulator1.0.0
...
compiler_moc_header_make_all: moc_emulator.cpp moc_aboutdialog.cpp moc_mainwindow.cpp
...
compiler_uic_make_all: ui_emulator.h ui_aboutdialog.h ui_mainwindow.h
compiler_uic_clean:
...
mainwindow.o: mainwindow.cpp app_types.h \
		mainwindow.h \
		ui_mainwindow.h \
		emulator.h \
		gfxfont.h \
